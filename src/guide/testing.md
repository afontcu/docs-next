...
Vue Test Utils is the official low-level component testing library that was written to provide users access to Vue specific APIs. If you are starting testing Vue application, we would recommend using Vue Testing Library, which is an abstraction over Vue Test Utils. 
